...
export default class SoulCarver extends MajorCooldown<SoulCarverCooldownCast> {
  ...
  constructor(options: Options) {
    super({ spell: SOUL_CARVER_TALENT }, options);
    this.addEventListener(Events.cast.by(SELECTED_PLAYER).spell(SOUL_CARVER_TALENT), this.onCast);
  }
      ...
      return {
        ...
        details: (
          <div>
            ...
            <SpellLink spell={SOUL_CARVER_TALENT} /> so that you benefit from{' '}
