  ...
  return (
    <SubSection title="Fiery Brand">
      <ExplanationRow>
        <Explanation>
          <p>
            <SpellLink spell={FIERY_BRAND_TALENT} /> reduces the damage dealt to you by targets with
            its debuff by <strong>40%</strong>.
          </p>
          <p>
            This chart shows your <SpellLink spell={FIERY_BRAND_TALENT} /> uptime along with the
            damage that you took. <strong>You do not need 100% uptime!</strong> However, damage
            taken without <SpellLink spell={FIERY_BRAND_TALENT} /> active (shown in{' '}
        ...
        <HitBasedOverview
          ...
          unmitigatedContent={
            <>
              <SpellLink spell={FIERY_BRAND_TALENT} /> would have reduced this by{' '}
              <strong>40%</strong>.
            </>
          }
        />
